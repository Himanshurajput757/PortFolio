  ...
  return (
    <section
     ...
     >
      ...
      {/* modal container */}
      {selectedProject && (
        <div className=' fixed mt-3 inset-0 z-50 flex items-center justify-center bg-black bg-opacity-90 p-4 '>
          <div className=' bg-gray-900 rounded-xl shadow-2xl lg:w-full w-[90%] max-w-3xl overflow-hidden relative '>
            ...
            <div className='flex flex-col'>
              <div className='w-full justify-center bg-gray-900 px-4 '>
              ...
              <div className=' lg:p-8 p-6 '>
                ...
                <div className=' flex flex-wrap gap-2 mb-6 '>
                  {selectedProject.tags.map((tag, index) => (
                    <span key={index} className='  bg-[#251f38] text-xs font-semibold text-purple-500 rounded-full px-2 py-1 mr-2 mb-2 '>{tag}</span>
                  ))}
                </div>
                <div className=' flex gap-4 '>
                  ...
                  className='w-1/2 bg-gray-800 hover:bg-purple-600 text-gray-400 lg:px-6 lg:py-2 px-2 py-1 rounded-xl lg:text-xl text-sm font-semibold text-center '
                  >
                    View Live
                  </a>
                </div>
